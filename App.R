...
ui = tagList(
  ...
  navbarPage(
    ...
    tabPanel("Amostragem Aleatória Simples",
             ...
             mainPanel(
               tabsetPanel(
                 tabPanel(inputId="analysisTabs","Calculadora Amostral",
                          ...
                          hidden(
                            div(id = "advanced1",
                                ...
                                h1('$$n=\\frac{n_0*N}{(N+n_0)}$$'),
                                h1('$$n_0=\\frac{z^2}{d^2}*\\frac{N}{(N-1)}*P(1-P)$$')
                          ...
                          hidden(
                            div(id = "advanced2",
                                ...
                                withMathJax(),
                                helpText('O tamanho da amostra é obtido por'),
                                h2('$$n=\\frac{n_0*N}{(N+n_0)}$$'),
                                h2('$$n_0=\\frac{z^2}{d^2}*S^2$$')
                            )
                          ),
...
server = function(input, output, session) {
  ...
  observe({
    ...
    toggle(id = "table", condition = input$checkbox=="propamostra")
    toggle(id = "table2", condition = input$checkbox=="medamostra")
    toggle(id = "txtout", condition = input$checkbox=="propamostra")
    toggle(id = "txtout1", condition = input$checkbox=="propamostra")
  ...
  observe({  
    if (input$checkbox=="medamostra") {
      ...
      updateTabsetPanel(session, inputId="analysisTabs")
    } 
    else if (input$checkbox=="propamostra")  {
